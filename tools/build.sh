...
cd TDycore-test/Steady-State_2D_Saturated_Flow_With_Linear_Pressure_Gradient_BCs_and_Non-Uniform_Block_Permeability/
...
echo '../TDycore-test/Steady-State_2D_Saturated_Flow_With_Linear_Pressure_Gradient_BCs_and_Non-Uniform_Block_Permeability/2d_block.cfg'>$PWD/qa-toolbox/config_files.txt
